...
The file `88-wii-u-gamecube-adapter.rules` should be placed in `/etc/udev/rulles.d/`.  This starts the service `wii-u-gc-adapter`, which is started by the file, `/etc/init.d/wii-u-gc-adapter`.
